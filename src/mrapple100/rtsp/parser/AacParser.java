...
import mrapple100.utils.ParsableBitArray;
import mrapple100.utils.ParsableByteArray;
...
public class AacParser {
    ...
    public AacParser(@NotNull String aacMode) {
    ...
    @Nullable
    public byte[] processRtpPacketAndGetSample(@NotNull byte[] data, int length) {
//        if (DEBUG)

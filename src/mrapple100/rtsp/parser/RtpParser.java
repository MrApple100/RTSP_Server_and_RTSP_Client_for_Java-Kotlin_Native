package mrapple100.rtsp.parser;
...
public class RtpParser {
    ...
    public static class RtpHeader {
        ...
        public static boolean searchForNextRtpHeader(@NotNull InputStream inputStream, @NotNull byte[] header /*out*/) throws IOException {
            if (header.length < 4)
        ...
        @Nullable
        public static RtpHeader parseData(@NotNull byte[] header, int packetSize) {
        ...
        public static int getPacketSize(@NotNull byte[] header) {
        ...
        public void dumpHeader() {
            System.out.println();
            System.out.println("RTP header version: " + version
                    + ", padding: " + padding
                    + ", ext: " + extension
                    + ", cc: " + cc
                    + ", marker: " + marker
    ...
    @Nullable
    public static RtpHeader readHeader(@NotNull InputStream inputStream) throws IOException {

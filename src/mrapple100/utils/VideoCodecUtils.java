...
//  public static final int NAL_FF_IGNORE       = 0xff0f001;
    ...
    public static int searchForH264NalUnitStart(
            ...
            int offset,
            int length,
            @NotNull AtomicInteger prefixSize) {
...
//    }
   ...
   public static int getH264NalUnitsNumber(
    ...
    public static int getH264NalUnits(
            ...
            int    dataOffset,
            int    length,
            @NotNull ArrayList<NalUnit> foundNals) {
...
//            @NotNull VideoCodecContext context,
//            @NotNull byte[] data,
//            int dataOffset,
//            int length) {
//
...
//    @Nullable
//    public static Size getImageSizeFromH264SpsNalUnit(@NotNull byte[] data, int offset, int length) {
...
//    @Nullable
//    public static Size getImageSizeFromH265SpsNalUnit(@NotNull byte[] data, int offset, int length) {
//        int nalUnitTypeIndex = getNalUnitStartCodePrefixSize(data, offset, length);
//        if (nalUnitTypeIndex > 0) {
//            byte nalUnitTypeOctet = data [offset + nalUnitTypeIndex];
//            byte nalUnitType = (byte)((nalUnitTypeOctet & 0x7E) >> 1);
...
//        }
//    }
    private static int getNalUnitStartCodePrefixSize(@NotNull byte[] data, int offset, int length) {
        if (length < 4)
            return -1;

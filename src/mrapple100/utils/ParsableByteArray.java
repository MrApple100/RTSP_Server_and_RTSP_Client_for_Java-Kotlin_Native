...
public final class ParsableByteArray {
    ...
    public String readNullTerminatedString(int length) {
        ...
        String result = fromUtf8Bytes(data, position, stringLength);
        position += length;
        return result;
    }
    ...
    public String readDelimiterTerminatedString(char delimiter) {
        ...
        String string = fromUtf8Bytes(data, position, stringLimit - position);
    ...
    public String readLine() {
        ...
        while (lineLimit < limit && !isLinebreak(data[lineLimit])) {
            lineLimit++;
        }
        ...
        String line = fromUtf8Bytes(data, position, lineLimit - position);
        position = lineLimit;
        if (position == limit) {
            return line;
        }

...
public class NetUtils {
    ...
    @NotNull
    public static SSLSocket createSslSocketAndConnect(@NotNull String dstName, int dstPort, int timeout) throws Exception {
       // if (DEBUG)
...
//        X509TrustManager trustManager = (X509TrustManager) trustManagers[0];
    ...
    @NotNull
    public static ArrayList<String> readResponseHeaders(@NotNull InputStream inputStream) throws IOException {
...
//        Assert.assertNotNull("Input stream should not be null", inputStream);
    ...
    public static int getResponseStatusCode(@NotNull ArrayList<String> headers) {
...
//    }
    ...
    @NotNull
    public static String readContentAsText(@NotNull InputStream inputStream, int length) throws IOException {
//        Assert.assertNotNull("Input stream should not be null", inputStream);
        if (length <= 0)
            return "";
